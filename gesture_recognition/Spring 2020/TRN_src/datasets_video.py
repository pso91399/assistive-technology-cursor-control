...
def return_jester(modality):
    # this is the dataset I want to training on
    filename_categories = '/home/ssd2/caiyiyang/datasets/jester-v1/category.txt'
    if modality == 'RGB':
        prefix = '{:05d}.jpg'
        #root_data = '/data/vision/oliva/scratch/bzhou/video/jester/20bn-jester-v1'
        root_data = '/home/ssd2/caiyiyang/datasets/jester-v1/videos/20bn-jester-v1'
        filename_imglist_train = '/home/ssd2/caiyiyang/datasets/jester-v1/train_videofolder.txt'
        filename_imglist_val = '/home/ssd2/caiyiyang/datasets/jester-v1/val_videofolder.txt'
    elif modality == 'Flow':
        root_data = '/home/ssd2/caiyiyang/datasets/jester-v1/videos/20bn-jester-v1'
        #root_data = '/mnt/localssd1/bzhou/something/flow'
        filename_imglist_train = '/home/ssd2/caiyiyang/datasets/jester-v1/train_videofolder.txt'

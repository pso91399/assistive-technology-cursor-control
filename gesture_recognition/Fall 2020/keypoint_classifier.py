...
if __name__ == '__main__':
    PALM_MODEL_PATH = os.path.join(
        sys.path[0],
        "../../examples/mediapipe_tracking/models/palm_detection_without_custom_op.tflite"
    )
    LANDMARK_MODEL_PATH = os.path.join(
        sys.path[0],
        "../../examples/mediapipe_tracking/models/hand_landmark_3d.tflite")
    ANCHORS_PATH = os.path.join(
        sys.path[0], "../../examples/mediapipe_tracking/models/anchors.csv")

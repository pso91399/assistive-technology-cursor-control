...
def parse_opts_offline():
    ...
    parser.add_argument(
        ...
        type=str,
        help=
        'Temporal transformation method in training. (random | ranpad)')
    parser.add_argument(
        '--temporal_pad',
        default=0,
        type=int,
    ...
    parser.add_argument(
        '--true_valid',
        action='store_true',
        help='If true avg recognition per clip is performent (not only temporal center crop)')
    parser.set_defaults(true_valid=False)
    parser.add_argument(
        '--adap_temp',
        action='store_true',
        help='If true the input frames > x is reduced (adap temporal cropping)')
    ...
    parser.add_argument(
        '--no_scrop',
        action='store_true',
        help='If true, denso images are not normalized cropped by subject')
    ...
    parser.add_argument(
        ...
        default=0.1, 
        type=float, 
        help='Threshold to predict none gestures')
    parser.add_argument(
        '--width_mult', 
        default=1.0, 
        type=float, 
    ...
    parser.add_argument(
        '--quantize', action='store_true', help='If true, model is quantized.')
...
def parse_opts_online():
    ...
    parser.add_argument('--no_first_lay_det', action='store_true', help='If true, first conv layer is changed.')
    parser.set_defaults(no_first_lay_det=False)
    parser.add_argument('--no_first_lay_clf', action='store_true', help='If true, first conv layer is changed.')
